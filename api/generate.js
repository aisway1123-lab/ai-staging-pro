...
export default async function handler(req, res) {
  ...
  if (action === 'stageImage') {
    ...
    const STYLE_PROMPTS = {
      japanese_muji_wabi_sabi: "Style: Muji-inspired wabi-sabi interior with a quiet morning atmosphere that feels bright yet calm. Floors are hand-scraped or subtly aged natural wood, pale worn stone, or fine linen-textured stone tiles — surfaces that carry a quiet sense of time. Emphasize lived-in stillness through subtle textured walls. Furniture combines pale wood, raw linen or cotton, unbleached hemp, and imperfect handmade ceramics — no single material dominates, each complements the others in an understated, balanced composition. Prioritize spatial emptiness with generous negative space. Lighting includes a ceiling fixture — such as a handcrafted washi paper pendant, natural fiber shade, or minimalist wood-framed paper lamp — and may include secondary lighting such as a low wooden floor lamp, ceramic table lamp, or paper shade wall sconce where appropriate to the room type. Windows, if present, are dressed with unbleached linen or cotton sheer panels that filter morning light softly.",
      natural_biophilic: "Style: High-end Natural Biophilic interior with a sunlit, restorative atmosphere. Floors echo the earth palette — warm terracotta tiles, natural stone, or light wood planks with visible grain. Palette builds from terracotta, moss green, and deep oat over a soft white base, layered so warm and cool earth tones balance each other rather than match. Greenery and artisan accents in natural materials serve as standalone focal points. Lighting includes a ceiling fixture — such as a woven rattan pendant, bamboo shade, or organic-form ceramic pendant — and may include secondary lighting such as a rattan floor lamp, terracotta table lamp, or woven wall sconce where appropriate to the room type. Windows, if present, are dressed with soft organic cotton or loosely woven linen curtains that filter warm natural light gently.",
      scandinavian_warm: "Style: High-end Warm Scandinavian urban apartment with a palette of clear whites, warm sand beige, and soft oat neutrals. Floors are pale ash or light oak wood planks, clean and seamless. Layer cool-white surfaces with warm wood and textile accents to create depth, avoiding a flat monotone effect. Lighting is bright and airy. Lighting includes a ceiling fixture — such as a single clean-lined pendant in white, brass, or natural paper — and may include secondary lighting such as a slim brass floor lamp, white ceramic table lamp, or minimal wall sconce where appropriate to the room type. One high-quality artisanal accent is placed asymmetrically as the sole decorative statement. Windows, if present, are dressed with sheer white or warm linen curtains that soften daylight without adding visual weight.",
      modern_quiet_luxury: "Style: High-end Modern Quiet Luxury interior with a sunlit, aspirational show-home quality. Floors are seamless cool grey stone, large-format warm taupe tiles, or polished concrete — refined and grounded. Palette spans cool greys, warm taupe, and charcoal with subtle metallic undertones — combine matte and polished surfaces for material contrast and visual depth. Lighting includes a ceiling fixture — such as a sculptural metal pendant, smoked glass globe, frosted glass cylinder, or integrated LED cove — and may include secondary lighting such as a tall arc floor lamp, smoked glass table lamp, or slim wall sconce where appropriate to the room type. Windows, if present, are dressed with floor-to-ceiling sheer curtains in soft grey, warm white, or dusty blush that add a layered, editorial quality.",
      retro_modern_tw: "Style: Retro modern with subtle Taiwanese character. Floors are vintage-patterned ceramic tiles, terrazzo with warm aggregate, or aged wood planks — surfaces that carry memory and place. Mix vintage wood, patterned tile, aged metal, and warm textiles so old and new elements contrast each other, creating a layered, story-rich space that still feels livable and uncluttered. Lighting includes a ceiling fixture — such as a vintage Edison bulb pendant, rattan cage shade, retro glass globe, or industrial-style ceiling lamp — and may include secondary lighting such as a vintage-style floor lamp, retro ceramic table lamp, or aged brass wall sconce where appropriate to the room type. Windows, if present, are dressed with light-filtering curtains in warm ivory, aged white, or faded warm tones that complete the lived-in softness.",
      korean_instagrammable_adult: "Style: High-end Instagrammable modern adult apartment with a creamy Morandi palette. Floors are seamless warm oat stone, pale micro-cement, or smooth light wood — refined and minimal. Palette of warm milk, oatmeal, and muted blush — layer smooth and softly textured surfaces, combine curved and linear forms so the composition feels visually rich but cohesive rather than flat. Furniture features sculptural, curved silhouettes as a defining characteristic. Lighting includes a ceiling fixture — such as a creamy sculptural pendant — and may include secondary lighting such as an arc floor lamp, slim wall sconce, or cream ceramic table lamp with editorial intention where appropriate to the room type. Windows, if present, are dressed with soft sheer curtains in warm white or cream that diffuse light with an airy, editorial quality."
    };
    const ROOM_PROMPTS = {

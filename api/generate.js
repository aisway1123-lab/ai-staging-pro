...
export default async function handler(req, res) {
  ...
  if (action === 'stageImage') {
    ...
    const STYLE_PROMPTS = {
      japanese_muji_wabi_sabi: "Style: Muji-inspired wabi-sabi interior with a quiet morning atmosphere that feels bright yet calm. Emphasize lived-in stillness through subtle textured walls. Natural wood furniture and organic linen or cotton fabrics ground the space, while a few imperfect handmade ceramics add a gentle sense of time. Prioritize spatial emptiness; any additional furniture must have realistic depths and functional proportions. A single handcrafted washi paper or natural fiber pendant light hangs from the ceiling. Windows are dressed with natural linen or cotton sheer curtains in muted, undyed tones.",
      natural_biophilic: "Style: High-end Natural Biophilic interior with a sunlit, restorative atmosphere. Palette: Muted earth tones (terracotta, moss green, deep oat) over a soft white base. Greenery and artisan accents are integrated as standalone, minimalist focal points. All furniture must be non-embedded with realistic depths. Lighting is bright and airy. A woven rattan or bamboo pendant light serves as the ceiling fixture. Soft organic cotton or linen curtains filter natural light gently.",
      scandinavian_warm: "Style: High-end Warm Scandinavian urban apartment with a palette of clear whites, warm sand beige, and soft oat neutrals. Lighting is bright and airy, complemented by sheer white curtains or soft linen. Decor features a single high-quality artisanal accent placed asymmetrically. A simple white or brass minimal pendant light hangs centrally from the ceiling.",
      modern_quiet_luxury: "Style: High-end Modern Quiet Luxury interior with a sunlit, aspirational show-home glow. Palette: Refined neutral spectrum of cool greys, warm taupe, and charcoal with subtle metallic undertones. Furniture must be standalone with realistic depths. Sophisticated lighting highlights material contrast. A sculptural metal or frosted glass pendant light serves as a refined ceiling focal point. Floor-to-ceiling sheer curtains in soft grey or warm white add a refined, layered look.",
      retro_modern_tw: "Style: Retro modern with subtle Taiwanese character. Hints of vintage atmosphere through furniture, colors, or textures. Balance nostalgic elements with modern cleanliness. The space should feel story-rich but still livable. All vintage-inspired furniture must be standalone with realistic depths. A vintage-toned Edison bulb pendant or retro-style ceiling fixture adds nostalgic character. Light-filtering curtains in warm ivory or aged white add a lived-in softness.",
      korean_instagrammable_adult: "Style: High-end Instagrammable modern adult apartment with a creamy Morandi palette of warm milk and oatmeal. Refined, smooth textures and editorial aesthetic. Lighting may include LED coves. Soft sheer draping curtains diffuse natural light. Furniture features sculptural, curved silhouettes. A creamy white sculptural pendant or arc floor lamp complements the editorial aesthetic."
    };
    const ROOM_PROMPTS = {
    ...
    const F_Negative = `Do not include: camera angle change, perspective shift, window shape change, window size change, window position change, wall structural modification, distorted geometry, warped perspective, bent lines, adding windows, adding doors, adding openings, architectural redesign, new rooms, new partitions, people, animals, text, watermark, logo, fantasy, surreal, cartoon, stylized.`;

...
export default async function handler(req, res) {
  ...
  if (action === 'stageImage') {
    ...
    const fullPrompt = `${A_Structure} ${STYLE_PROMPTS[styleKey]} ${ROOM_PROMPTS[roomKey]} ${E_Presentation} ${F_Negative}${dynamicPrompt}`;

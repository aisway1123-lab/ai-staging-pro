...
export default async function handler(req, res) {
  ...
  if (action === 'stageImage') {
    ...
    const A_Structure = `Stage this empty room with furniture and decor matching the style above. Replace floor surface with a new seamless material appropriate to the selected style — do not preserve the original floor. Replace ceiling fixtures with style-appropriate lighting that best suits the room type — this may include pendant lights, flush mount lights, track lighting, recessed lighting, or other ceiling-mounted fixtures. Remove all wires, cables, clutter, and non-structural objects from walls. Keep all walls, windows, and doors exactly as shown.`;
